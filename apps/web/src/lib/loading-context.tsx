...
export function LoadingProvider({ children }: { children: React.ReactNode }) {
  ...
  const startLoading = useCallback(
    (id: string, options: Partial<LoadingOperation> = {}) => {
  ...
  const updateLoading = useCallback(
    (id: string, updates: Partial<LoadingOperation>) => {
      setOperations((prev) => {
  ...
  const startBulkOperation = useCallback(
    (operationList: Array<{ id: string; text: string }>) => {
  ...
  const updateBulkProgress = useCallback(
