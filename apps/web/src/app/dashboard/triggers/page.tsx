      ...
      <div className="p-6 space-y-6">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-400">{totalTriggers.toLocaleString()}</p>
                </div>
        ...
        <div className="space-y-4">
          {filteredTriggers.map((trigger) => {
            ...
            return (
              <Card key={trigger.id} className="bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-3">
                      <div className={`w-10 h-10 bg-gradient-to-r ${triggerColors[trigger.type]} rounded-lg flex items-center justify-center`}>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <div className="text-red-300 text-xs mt-1">{trigger.error}</div>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-lg font-semibold text-white">{trigger.triggerCount.toLocaleString()}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      {trigger.type === 'schedule' && (
                        <div className="text-sm text-gray-300">
                          <code className="bg-black/20 px-2 py-1 rounded">{trigger.schedule}</code>
                          {trigger.timezone && (
                            <div className="text-xs text-gray-400 mt-1">{trigger.timezone}</div>
                          )}
                        </div>
                      )}
                      {trigger.config && (
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/10">
                    <div className="flex items-center space-x-2">
                      <Button
                        ...
                        className={trigger.status === 'active' ? 'text-yellow-400 hover:text-yellow-300' : 'text-green-400 hover:text-green-300'}
                      >
        ...
        {filteredTriggers.length === 0 && (
          <Card className="bg-white/5 border-white/10">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-white mb-2">No triggers found</h3>
